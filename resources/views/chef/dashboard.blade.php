    ...
    <div class="flex-1 flex flex-col min-w-0">
        ...
        <header class="p-10 pb-5 flex justify-between items-end">
            <div>
                ...
                <p class="text-gray-500 uppercase text-[10px] font-bold tracking-wider mt-1">Aperçu des performances de
                    l'équipe</p>
            </div>
                ...
                @forelse($projets as $projet)
                    <div class="bg-white rounded border border-gray-200 p-6 hover:border-indigo-300 transition-colors">
                        <div class="flex justify-between items-start mb-4">
                            ...
                            <span
                                class="text-[9px] font-bold uppercase bg-gray-100 text-gray-500 px-2 py-1 rounded border">
                        ...
                        <div class="mt-4 mb-6">
                            ...
                            <div class="w-full bg-gray-100 h-1.5 rounded-full overflow-hidden">
                                <div class="bg-indigo-600 h-full transition-all" style="width: {{ $percent }}%">
                                </div>
                            </div>
                        </div>

                        <div class="flex justify-between items-center pt-4 border-t border-gray-50">
                            <span class="text-[9px] font-bold text-gray-400 uppercase">Tâches:
                                {{ $done }}/{{ $total }}</span>
